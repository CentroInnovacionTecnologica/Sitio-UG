...
export const CATALOGO: Categoria[] = [
  ...
  // SECCIÓN DE BORDADO
  {
    ...
    subcategorias: [
      ...
      {
        slug: 'bordado-plano', nombre: 'Bordado de Banderines en 2X2 MTS', sinonimos: ['bordado plano', 'cuadro bordado', 'gran bordado'],
        productos: [
          {
            nombre: 'Banderín Escolar Bordado',
            imagen: '/assets/banderines/BanderinBordado.png',
            descripcion:
              'Banderín escolar bordado con escudo, nombre de la institución, clave y localidad. Acabado en terciopelo con fleco y medidas a solicitud.',
            etiqueta: 'PERSONALIZABLE',
            fondo: '#ebeaea',
            sinonimos: [
              'banderin', 'banderines', 'banderin escolar', 'banderin bordado',
              'bandera escolar', 'estandarte', 'estandarte escolar', 'pendon',
              'escudo bordado', 'logo bordado', 'bordado a mano', 'bordado plano',
              'nombre de escuela', 'clave de escuela', 'cct', 'primaria', 'secundaria',
              'preparatoria', 'universidad', 'escolta', 'ceremonia', 'honores',
              'desfile', 'terciopelo', 'fleco', 'flecos', 'dorado', 'azul marino',
            ],
          },
        ],
      },
